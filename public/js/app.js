    ...
    methods: {
        ...
        openModal: function openModal(id) {
            ...
            axios.get(this.bUrl + '/posts/' + id).then(function (response) {
                console.log(response); // show if success
                _this3.updatedContent = response.data; //we are putting data into our posts array
            }).catch(function (error) {
                console.log(error); // run if we have error
            });
        },
        ...
        deletePost: function deletePost(id) {
            ...
            axios.get(this.bUrl + '/deletePost/' + id).then(function (response) {
                console.log(response); // show if success
                _this5.posts = response.data; //we are putting data into our posts array
            }).catch(function (error) {
                console.log(error); // run if we have error
            });
        },
        likePost: function likePost(id) {
            ...
            axios.get(this.bUrl + '/likePost/' + id).then(function (response) {
                console.log(response); // show if success
                _this6.posts = response.data; //we are putting data into our posts array
            }).catch(function (error) {
                console.log(error); // run if we have error
            });
        },
        removeLikePost: function removeLikePost(id) {
            var _this7 = this;

            axios.get(this.bUrl + '/removeLikePost/' + id).then(function (response) {
                console.log(response); // show if success
                _this7.posts = response.data; //we are putting data into our posts array
            }).catch(function (error) {
                console.log(error); // run if we have error
            });
        },
